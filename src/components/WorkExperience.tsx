...
function WorkExperienceCard(
  ...
  return (
    <div className="backdrop-blur-sm  bg-gradient-to-r from-teal-800/50 to-stone-900/80 sm:to-black p-12 py-20 sm:rounded-2xl ">
      <div className="mb-4 ">
        {start} - {end}
      </div>
      <div className="mb-4 text-red-600 font-bold">{title}</div>
  ...
  return (
    <div className="mx-auto text-xl container flex justify-center">
      <div className={`bg-black text-white bg-black/0 sm:px-10 px-0 gap-4 flex flex-col ${ContainerSize.containerWidth} `}>
        <div className="text-6xl md:text-7xl lg:text-7xl mt-32 mb-4 sm:px-0 px-10">Work Experience</div>
