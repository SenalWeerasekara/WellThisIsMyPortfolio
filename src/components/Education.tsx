...
function educationCard(
  ...
  return (    
    <div className="bg-gradient-to-r from-yellow-800/50 to-stone-900/0 sm:to-black p-12 sm:rounded-2xl rounsded py-20">
  ...
  return (
    <div className="mx-auto text-xl container flex justify-center">
      <div className={`bg-black text-white bg-black/0 sm:px-10 px-0 gap-4 flex flex-col ${ContainerSize.containerWidth}`}>
        ...
        <div className="text-6xl md:text-7xl  lg:text-8xl sm:px-0 px-10 mb-12 mt-32">Education</div>
